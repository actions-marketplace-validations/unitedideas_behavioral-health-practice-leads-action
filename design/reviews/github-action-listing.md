...
Public repository metadata verified: `2026-07-15T00:35:18Z`
...
- Mobile keeps the complete repository description, free-preview statement, $9 full-edition boundary, buyer-paid usage disclosure, Apify destination, and Marketplace handoff readable above the file table. GitHub places the file table ahead of the README; that ordering is controlled by GitHub rather than repository CSS.
...
- Copy, price, secret handling, cost cap, data limitations, and explicit non-outreach boundary are consistent across the repository metadata and README. The current public description explicitly names credentialing, provider-enrollment, and medical-billing research; the public topic set carries those same buyer-intent terms.
...
Any source, tag, release, or Marketplace-state change after the revisions above, or any public repository metadata change after `2026-07-15T00:35:18Z`, invalidates this review.
